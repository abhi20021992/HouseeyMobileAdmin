...
@Component({
  selector: 'houseey-tab1',
  template: `
    <p>
      Early home automation began with labor-saving machines. Self-contained electric or gas powered
      ...
      <a target="_blank" href="https://en.wikipedia.org/wiki/Electric_power_distribution"
