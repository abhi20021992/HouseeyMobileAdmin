...
@Component({
  selector: 'houseey-user-activity',
      ...
      <nb-card-header>
        ...
        <div class="dropdown ghost-dropdown" ngbDropdown>
          ...
          <ul ngbDropdownMenu class="dropdown-menu">
            <li class="dropdown-item" *ngFor="let t of types" (click)="getUserActivity(t); type = t">
              {{ t }}
            </li>
          </ul>
        </div>
...
export class ECommerceUserActivityComponent implements OnDestroy {
  ...
  constructor(private themeService: NbThemeService, private userActivityService: UserActivityData) {
    this.themeService
      .getJsTheme()
