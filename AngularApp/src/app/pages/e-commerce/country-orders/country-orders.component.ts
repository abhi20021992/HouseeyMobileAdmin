...
@Component({
  selector: 'houseey-country-orders',
  ...
  template: `
    <nb-card [size]="breakpoint.width >= breakpoints.md ? 'medium' : 'xxlarge'">
      ...
      <nb-card-body>
        <houseey-country-orders-map (select)="selectCountryById($event)" countryId="USA"> </houseey-country-orders-map>
        <houseey-country-orders-chart
