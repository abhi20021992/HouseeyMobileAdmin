...
export class LeadService {
  ...
  create(value: Lead) {
    return this.http
      ...
      .subscribe((x) => {
        this.commonService.showNotification(`Lead with name ${value.FirstName} created`, 'success', true);
        return true;
      });
  }
  ...
  addNote(note: LeadNote) {
    return this.http
      ...
      .subscribe((x) => {
        this.commonService.showNotification(`Lead note updated`, 'success', true);
        return true;
      });
  }
  ...
  addSiteVisit(visit: LeadSiteVisit) {
    return this.http
      ...
      .subscribe((x) => {
        this.commonService.showNotification(`Lead visit scheduled`, 'success', true);
        return true;
      });
  }
  ...
  sendSMS(sms: LeadSMS) {
    return this.http
      ...
      .subscribe((x) => {
        this.commonService.showNotification(`Lead message sent`, 'success', true);
        return true;
      });
  }
  ...
  sendEmail(email: LeadEmail) {
    return this.http
      ...
      .subscribe((x) => {
        this.commonService.showNotification(`Lead email sent`, 'success', true);
        return true;
      });
  }
